...
import DashboardCard08 from '../partials/dashboard/AssetTypeReturnLineChartCard';
...
import HighlightsCard from '../partials/dashboard/HighlightsCard';
           ...
           <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-8">
              ...
              <div className="mb-4 sm:mb-0">
                <h1 className="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Your Portfolio at a glance</h1>
              </div>
